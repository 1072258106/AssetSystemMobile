...
public class PushDemoReceiver extends BroadcastReceiver {
        ...
        switch (bundle.getInt(PushConsts.CMD_ACTION)) {
            case PushConsts.GET_MSG_DATA:
                ...
                if (payload != null) {
            		...
            		setData(data);
                    Intent intent1=new Intent(context,GetuiActivity.class);
	...
	private void setData(String data) {
		...
		String zzlb = StringUtils.substringBetween(data, "，", "：");
		String zzbh = StringUtils.substringAfterLast(data, "：");
		String user = StringUtils.substringBefore(data, "您");
		...
		DatabaseHelper helper = new DatabaseHelper(context, "Message.db");
